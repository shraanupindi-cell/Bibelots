...
const pill = {
  ...
  color: '#2A1A17', outline: 'none', textAlign: 'center', letterSpacing: '0.03em',
}
  ...
  return (
    <div style={{
      ...
      <div style={{ width: '100%', maxWidth: '460px', animation: 'fadeUp 0.5s ease forwards' }}>
        <h2 style={{
          fontFamily: 'Inconsolata, monospace', fontSize: '22px', fontWeight: 400,
          color: '#2A1A17', textAlign: 'center', marginBottom: '2rem', letterSpacing: '0.04em',
        }}>Create Collection</h2>

        <div style={{
          border: '0.5px dashed #9A8A87', borderRadius: '8px',
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px' }}>
            ...
            <select style={{ ...pillSelect, background: 'none', backgroundImage: pillSelect.backgroundImage, backgroundRepeat: 'no-repeat', backgroundPosition: 'right 14px center' }}
              value={form.emotion} onChange={e => set('emotion', e.target.value)}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px' }}>
            ...
            <select style={{ ...pillSelect, background: 'none', backgroundImage: pillSelect.backgroundImage, backgroundRepeat: 'no-repeat', backgroundPosition: 'right 14px center' }}
              value={form.acquisition} onChange={e => set('acquisition', e.target.value)}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px' }}>
            ...
            <select style={{ ...pillSelect, background: 'none', backgroundImage: pillSelect.backgroundImage, backgroundRepeat: 'no-repeat', backgroundPosition: 'right 14px center' }}
              value={form.material_type} onChange={e => set('material_type', e.target.value)}>
        ...
        <div style={{ display: 'flex', gap: '10px', justifyContent: 'center', marginBottom: '12px' }}>
          <button onClick={handleAdd} style={{
            ...
            border: '0.5px solid #2A1A17', background: '#2A1A17', color: '#D4C4BF',
            fontFamily: 'Inconsolata, monospace', fontSize: '12px', letterSpacing: '0.06em',
          }}>Add Object</button>
          <button onClick={() => setForm(EMPTY)} style={{
            padding: '9px 28px', borderRadius: '99px',
            border: '0.5px solid #2A1A17', background: 'none', color: '#2A1A17',
            fontFamily: 'Inconsolata, monospace', fontSize: '12px', letterSpacing: '0.06em',
          }}>Clear</button>
        </div>
        ...
        <div style={{ display: 'flex', justifyContent: 'center', marginBottom: '1.5rem' }}>
          <button onClick={() => setCollOpen(o => !o)} style={{
            ...
            border: '0.5px solid #2A1A17', background: 'none', color: '#2A1A17',
            fontFamily: 'Inconsolata, monospace', fontSize: '12px', letterSpacing: '0.04em',
          }}>
